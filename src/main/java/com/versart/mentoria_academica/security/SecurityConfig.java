...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        ...
        .authorizeRequests(httpRequest -> httpRequest
            ...
            .requestMatchers(HttpMethod.PUT,"/v1/mentores/**").hasRole("ADMIN")
            .requestMatchers(HttpMethod.DELETE,"/v1/mentores/**").hasRole("ADMIN")
            .requestMatchers(HttpMethod.POST,"/v1/departamentos/**").hasRole("ADMIN")
            .requestMatchers(HttpMethod.PUT,"/v1/departamentos/**").hasRole("ADMIN")
            .requestMatchers(HttpMethod.DELETE,"/v1/departamentos/**").hasRole("ADMIN")
